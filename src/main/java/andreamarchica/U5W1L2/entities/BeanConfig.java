...
/*    @Bean({"Tavolo1"})
    com.epicode.U5D2.entities.Table getTable1(@Value("${seat.price}") double seatPrice) {
        return new com.epicode.U5D2.entities.Table(1, 5, true, seatPrice);
    }

    @Bean({"Tavolo2"})
    com.epicode.U5D2.entities.Table getTable2(@Value("${seat.price}") double seatPrice) {
        return new com.epicode.U5D2.entities.Table(2, 4, true, seatPrice);
    }

    @Bean({"Tavolo3"})
    com.epicode.U5D2.entities.Table getTable3(@Value("${seat.price}") double seatPrice) {
        return new com.epicode.U5D2.entities.Table(3, 8, true, seatPrice);
    }*/
}
